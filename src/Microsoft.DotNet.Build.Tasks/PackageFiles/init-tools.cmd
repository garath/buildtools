...
@echo on
call "%DOTNET_CMD%" build "%TOOLRUNTIME_DIR%\ilasm\ilasm.depproj" %DEFAULT_RESTORE_ARGS% -r %NATIVE_TOOLS_RID% --source https://dotnetmygetlegacy.blob.core.windows.net/dotnet-core/index.json /p:ILAsmPackageVersion=%ILASMCOMPILER_VERSION%
